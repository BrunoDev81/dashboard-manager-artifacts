const TEMPLATE = {"charts":["risk-matrix","timeline","status-grid"],"description":"Dashboard ejecutivo de alto nivel para seguimiento integral del negocio, alertas, decisiones y acciones prioritarias.","key":"executive-cockpit","insights":["Oportunidad prioritaria","Desvio relevante","Accion sugerida","Riesgo controlado"],"category":"EJECUTIVO","layout":"executive-cockpit","name":"Executive Cockpit","kpis":["Ventas","Margen","Riesgos","Decisiones"],"editableStateKeys":["comentarios_ejecutivos","decisiones","acciones_prioritarias","riesgos"]};
