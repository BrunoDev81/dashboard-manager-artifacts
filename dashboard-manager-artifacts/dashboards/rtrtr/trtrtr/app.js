const TEMPLATE = {"charts":["donut","risk-matrix","action-list"],"description":"Dashboard para seguimiento de inspecciones, lotes, rechazos y no conformidades.","key":"quality-control","insights":["Oportunidad prioritaria","Desvio relevante","Accion sugerida","Riesgo controlado"],"category":"CALIDAD","layout":"quality-review","name":"Control de Calidad","kpis":["Score calidad","Errores","Rechazos","Acciones"],"editableStateKeys":["observaciones","acciones_calidad","revisiones"]};
