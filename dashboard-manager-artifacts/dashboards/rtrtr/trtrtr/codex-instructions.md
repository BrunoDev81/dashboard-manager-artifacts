...
Datasets permitidos:
calidad_lotes, productos_catalogo
...
observaciones, acciones_calidad, revisiones
...
Crear dashboard.manifest.json con entrypoint index.html, versión 1.0.0, requiresApi: true, allowedDataSources: [], editableStateKeys: [] y staticDataFiles: [] hasta que Dashboard Manager los habilite o se agreguen archivos versionados.
