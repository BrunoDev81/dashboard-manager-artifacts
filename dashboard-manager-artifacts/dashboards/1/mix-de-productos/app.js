const TEMPLATE = {"charts":["funnel","line","ranking"],"description":"Dashboard para analizar participacion, concentracion y evolucion del mix de productos.","key":"product-mix-analysis","insights":["Oportunidad prioritaria","Desvio relevante","Accion sugerida","Riesgo controlado"],"category":"COMERCIAL","layout":"portfolio-mix","name":"Mix de Productos","kpis":["Mix top","Concentracion","Familias","Caida"],"editableStateKeys":["comentarios","acciones_mix","simulaciones"]};
