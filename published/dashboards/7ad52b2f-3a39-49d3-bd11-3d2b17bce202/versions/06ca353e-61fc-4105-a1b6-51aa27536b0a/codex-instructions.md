...
Nombre sugerido: Ranking de productos pedidos
...
Usar como referencia conceptual el template activo 'Dashboard en blanco' (blank-dashboard): Base técnica sin estructura de negocio. Elegí tus propios datasets y datos editables desde la administración del dashboard.
...
Filtros deseados: No especificado.
...
```json
{
  "name": "Ranking de productos pedidos",
  "description": "Mostrar a los vendedores los productos más y menos pedidos según litros_pedidos.",
  "entrypoint": "index.html",
  "version": "1.0.0",
  "requiresApi": true,
  "visualIdentity": "GRUPO_DISAL_LOCKED",
  "allowedDataSources": ["pedidos"],
  "editableStateKeys": [],
  "staticDataFiles": []
}
```
